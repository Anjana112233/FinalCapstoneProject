...
public class ErrorController {
    ...
    public String error404(HttpServletRequest request) {
        ...
        //log.info("endpoint:/error/404 - Requested URL not found : " + request.getMethod()); for only error
        log.info("endpoint:/error/404 - Requested URL not found : " + request.getRequestURI());
